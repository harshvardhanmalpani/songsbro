...
$url = 'http://api.hungama.com/webservice/hungama/content/music/playlist_details?user_id=65641701&content_id=4106&hardware_id=867512028232920&images=50x50';
...
{
	$imageset=copyimage($single['images']['image_50x50'][0],$filepath);
	...
	$top40list.= '<a href="#" id='. $single['content_id']. ' onClick=\'play(this.id,"'.$song_det.'");\' title=\''.$single_title.' - '.$single_aname .'\'><img width=50 height=50 src=\''.$imageset.' \' alt=\''.$single_title.'\' /></a>';
}
$file = fopen("top40.php","w");
